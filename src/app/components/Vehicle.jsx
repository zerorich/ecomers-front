...
// function Navbar() {
//   return (
//     <header className="flex justify-between my-5 mx-10">
//       <div className="flex items-center gap-2">
//         <img src="/img1.svg" alt="logo" className="w-[50px] h-[50px]" />
//         <p className="font-[600] text-lg">Car Rental</p>
//       </div>

//       <ul className="flex items-center gap-4">
//         <li className="font-[600] cursor-pointer">Home</li>
//         <li className="font-[600] cursor-pointer">Vehicles</li>
//         <li className="font-[600] cursor-pointer">Details</li>
//         <li className="font-[600] cursor-pointer">About Us</li>
//         <li className="font-[600] cursor-pointer">Contact Us</li>
//       </ul>
...
//     distance: 500,
//     image:
//       'https://images.unsplash.com/photo-1616781137294-3b5cbb3a1db7?auto=format&fit=crop&w=800&q=80',
//   },
//   {
//     id: 2,
...
//     distance: 600,
//     image:
//       'https://images.unsplash.com/photo-1571607388263-4a46a575d846?auto=format&fit=crop&w=800&q=80',
//   },
//   {
//     id: 4,
...
//     distance: 550,
//     image:
//       'https://images.unsplash.com/photo-1614436163996-22ca0f224b25?auto=format&fit=crop&w=800&q=80',
//   },
//   {
//     id: 5,
//     name: 'Toyota Hilux',
...
//     distance: 700,
//     image:
//       'https://images.unsplash.com/photo-1616772743214-1f28a8acaf75?auto=format&fit=crop&w=800&q=80',
//   },
//   {
//     id: 6,
...
//     active === 'all'
//       ? vehicles
//       : vehicles.filter((v) => v.type.toLowerCase() === active.toLowerCase());
...
// function Footer() {
//   return (
//     <footer className="border-t-4 border-blue-600 bg-white">
