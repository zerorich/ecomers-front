                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            ...
                            <a
                                href="#"
                                className="block w-[180px] h-[55px] bg-black rounded-xl flex items-center px-3 hover:opacity-90 transition"
                            >
                                <img src="/apple.svg" alt="Apple" className="w-[28px] h-[28px] mr-3" />
                                <div className="leading-tight">
                                    <div className="text-[11px] text-white">Download on the</div>
                                    <div className="text-[19px] font-semibold text-white -mt-1">App Store</div>
                                </div>
                            </a>
                            ...
                            <a
                                ...
                                className="block w-[180px] h-[55px] bg-black rounded-xl flex items-center px-3 hover:opacity-90 transition"
                            >
                                <img src="/playmarket.svg" alt="Google Play" className="w-[30px] h-[30px] mr-3" />
                                <div className="leading-tight">
                                    <div className="text-[10px] text-white">GET IT ON</div>
                                    <div className="text-[18px] font-semibold text-white -mt-1">Google Play</div>
                                </div>
                            </a>
                        </div>
                    </div>
